...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2>مرحباً <?php echo new \Illuminate\Support\EncodedHtmlString($user->full_name ?? 'عميلنا العزيز'); ?>,</h2>
            ...
            <div style="text-align: center;">
                <a href="<?php echo new \Illuminate\Support\EncodedHtmlString($resetUrl); ?>" class="button">🔑 إعادة تعيين كلمة المرور</a>
            </div>

            <div class="warning">
                <strong>⚠️ ملاحظة مهمة:</strong>
                <ul style="margin: 10px 0 0 20px;">
                    <li>هذا الرابط صالح لمدة <?php echo new \Illuminate\Support\EncodedHtmlString(config('auth.passwords.users.expire', 60)); ?> دقيقة فقط</li>
        ...
        <div class="footer">
            <p>&copy; <?php echo new \Illuminate\Support\EncodedHtmlString(date('Y')); ?> LapGeneus. جميع الحقوق محفوظة.</p>
            <p>هذا بريد إلكتروني آلي، يرجى عدم الرد عليه.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\Windows.11\Desktop\projectAmar\laravel_Restful_API\resources\views/emails/reset-password.blade.php ENDPATH**/ ?>